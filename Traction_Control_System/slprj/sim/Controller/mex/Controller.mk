...
MODEL                = Controller
MODULES              = Controller_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Controller_msf.mexw64
...
MODELLIB                  = Controller_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/ibaad/MATLAB/Projects/Traction_Control_System/slprj/sim/Controller/Controllerlib.lib
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/Controller \
...
Controller_msf.obj : $(START_DIR)/slprj/sim/Controller/Controller_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/Controller/Controller_msf.c
