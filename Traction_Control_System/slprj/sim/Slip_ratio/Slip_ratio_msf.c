...
#define S_FUNCTION_NAME Slip_ratio_msf
#endif
...
jj53gj5rgd1 * dw = ( jj53gj5rgd1 * ) ssGetDWork ( S , 0 ) ; real_T const *
i_hksbruxfib = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_khenfznkyi = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { Slip_ratio
( & ( dw -> rtm ) , i_hksbruxfib , i_khenfznkyi , o_B_1_1 , & ( dw -> rtb ) ,
...
mr_Slip_ratio_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 )
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_Slip_ratio_MdlInfoRegFcn
( S , "Slip_ratio" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( jj53gj5rgd1 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { jj53gj5rgd1 * dw = (
jj53gj5rgd1 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } jqaspd55h2
...
* S , int_T tid ) { jj53gj5rgd1 * dw = ( jj53gj5rgd1 * ) ssGetDWork ( S , 0 )
; real_T const * i_hksbruxfib = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_khenfznkyi = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid !=
PARAMETER_TUNING_TID ) { Slip_ratio ( & ( dw -> rtm ) , i_hksbruxfib ,
i_khenfznkyi , o_B_1_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { jj53gj5rgd1 * dw = (
jj53gj5rgd1 * ) ssGetDWork ( S , 0 ) ; fwch1ast5j * localZCSV = ( fwch1ast5j
* ) ssGetNonsampledZCs ( S ) ; lnxhlds2xj ( & ( dw -> rtb ) , localZCSV ) ; }
static void mdlTerminate ( SimStruct * S ) { jj53gj5rgd1 * dw = ( jj53gj5rgd1
* ) ssGetDWork ( S , 0 ) ; jrcc0fcp4a ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_Slip_ratio_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_Slip_ratio_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 ,
...
mr_Slip_ratio_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
