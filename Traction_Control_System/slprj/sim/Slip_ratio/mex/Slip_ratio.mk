...
MODEL                = Slip_ratio
MODULES              = Slip_ratio_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Slip_ratio_msf.mexw64
MAKEFILE             = Slip_ratio.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = C:/Users/ibaad/MATLAB/Projects/Traction_Control_System
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"C:\Program Files\MATLAB\R2023a\extern\lib\win64\microsoft" -L"C:\Program Files\MATLAB\R2023a/extern/lib/win64/microsoft" libmwipp.lib libfixedpoint.lib libmwmathutil.lib libmwsl_AsyncioQueue.lib sf_runtime.lib libmwslexec_simlog.lib libmwcoder_ToAsyncQueueTgtAppSvc.lib libmwsl_simtarget_instrumentation.lib libmwsl_simtarget_core.lib libmwstringutil.lib libmx.lib libmex.lib
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 0

#--------------------------- Model and reference models -----------------------
MODELLIB                  = Slip_ratio_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/ibaad/MATLAB/Projects/Traction_Control_System/slprj/sim/Slip_ratio/Slip_ratiolib.lib
MODELREF_LINK_RSPFILE     = Slip_ratio_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/Slip_ratio \
...
Slip_ratio_msf.obj : $(START_DIR)/slprj/sim/Slip_ratio/Slip_ratio_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/Slip_ratio/Slip_ratio_msf.c
