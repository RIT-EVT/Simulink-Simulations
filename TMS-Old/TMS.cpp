 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Sep 21 20:25:09 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                TMS
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                pumpSpeed
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                fan1Speed
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                fan2Speed
...
extern void TMS_Outputs_wrapper(const real_T *Temp,
  real_T *pumpSpeed,
  real_T *fan1Speed,
  real_T *fan2Speed);
...
{
  const real_T *Temp = (real_T *) ssGetInputPortRealSignal(S, 0);
  real_T *pumpSpeed = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *fan1Speed = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *fan2Speed = (real_T *) ssGetOutputPortRealSignal(S, 2);
  TMS_Outputs_wrapper(Temp, pumpSpeed, fan1Speed, fan2Speed);
}
